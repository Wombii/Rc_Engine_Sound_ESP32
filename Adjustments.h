...
volatile int engineIdleVolumePercentage = 30; // the engine volume will be throttle dependent (usually = 60%, never more than 100%!)
...
const uint16_t escPulseSpan = 1600; // pulseZero +/- this value (> 500 = limited top speed, about 1600 for King Hauler)
...
const int8_t dec = 2; // Deceleration step (2) 1 = slow for locomotive engine, 5 = fast for trophy truck
